/* ==========================================================
   INTRANET_AUTHORITY_RECONCILIATION
   Versão 1.0
   Autor: Miguel Mimoso Correia

   Reconciliação e enriquecimento de autoridades no editor
   de autoridades do Koha.
   ...
   Integração UNIMARC:
   - 017 — identificadores externos
   - 200 — forma autorizada
   - 400 — formas variantes

   Princípios:
   - o catalogador confirma sempre a identidade antes de aplicar dados;
   - falhas externas nunca impedem a edição normal no Koha;
   - dados externos são validados e escapados antes de entrar no DOM.
...
(function () {
    ...
    if (window.INTRANET_AUTHORITY_RECONCILIATION_ACTIVE) return;
    window.INTRANET_AUTHORITY_RECONCILIATION_ACTIVE = true;
    window.INTRANET_AUTHORITY_RECONCILIATION_VERSION = "1.0";

    if (!window.jQuery) {
        console.warn("Authority Reconciliation: jQuery não está disponível.");
        return;
    }
    ...
    */
    ...
    var INTRANET_AUTHORITY_RECONCILIATION_CSS = `
:root {
    --intranet-authority-reconciliation-css-version: 1;
    --intranet-authority-reconciliation-accent:#007fae;
    --intranet-authority-reconciliation-border:#d0d7de;
    --intranet-authority-reconciliation-bg:#fff;
    --intranet-authority-reconciliation-muted:#667085;
}

#intranet-authority-reconciliation-tab {
    position:fixed;
    left:0;
    top:18px;
    z-index:10050;
...
#intranet-authority-reconciliation-tab:hover {
    background:#f8fafc;
    color:#0f4c75;
    border-color:#8fa0ad;
}

#intranet-authority-reconciliation-root {
    position:fixed;
    left:0;
    top:0;
    bottom:0;
    width:var(--intranet-authority-reconciliation-dock-width,min(42vw,980px));
    min-width:340px;
    max-width:72vw;
    z-index:10040;
    background:var(--intranet-authority-reconciliation-bg);
...
#intranet-authority-reconciliation-root.intranet-authority-reconciliation-open {
    transform:translateX(0);
}

#intranet-authority-reconciliation-resizer {
    position:absolute;
    top:0;
    right:-5px;
    width:10px;
...
#intranet-authority-reconciliation-resizer:after {
    content:"";
    position:absolute;
    top:0;
    bottom:0;
...
#intranet-authority-reconciliation-resizer:hover:after,body.intranet-authority-reconciliation-resizing #intranet-authority-reconciliation-resizer:after {
    background:#007fae;
}

body.intranet-authority-reconciliation-resizing {
...
body.intranet-authority-reconciliation-docked {
    box-sizing:border-box!important;
    width:100%!important;
    padding-left:var(--intranet-authority-reconciliation-dock-width)!important;
    transition:padding-left .18s ease!important;
    overflow-x:hidden!important;
}

body.intranet-authority-reconciliation-resizing.intranet-authority-reconciliation-docked {
    transition:none!important;
}

body.intranet-authority-reconciliation-docked #intranet-authority-reconciliation-tab {
    /* O botão pertence ao título da página; não acompanha a margem do painel. */
}

body.intranet-authority-reconciliation-resizing #intranet-authority-reconciliation-tab {
    transition:none!important;
}
...
.intranet-authority-reconciliation-head {
    display:flex;
    align-items:center;
...
.intranet-authority-reconciliation-brand {
    display:flex;
    align-items:center;
    gap:8px;
    min-width:0;
...
.intranet-authority-reconciliation-brand strong {
    font-size:15px;
    white-space:nowrap;
}

.intranet-authority-reconciliation-context {
    font-size:11px;
    color:#667085;
    overflow:hidden;
...
.intranet-authority-reconciliation-close {
...
.intranet-authority-reconciliation-close:hover {
    background:#f8fafc;
}

.intranet-authority-reconciliation-body {
    flex:1 1 auto;
    overflow:auto;
    padding:12px;
    background:#f8fafc;
...
.intranet-authority-reconciliation-toolbar {
    display:flex;
    gap:7px;
    flex-wrap:wrap;
    align-items:center;
...
.intranet-authority-reconciliation-btn,.intranet-authority-reconciliation-link {
    display:inline-flex;
    align-items:center;
...
.intranet-authority-reconciliation-btn:hover,.intranet-authority-reconciliation-link:hover {
...
.intranet-authority-reconciliation-primary {
    border-color:#007fae!important;
    color:#006b92!important;
    background:#f2fbff!important;
}

.intranet-authority-reconciliation-searchbar {
    display:flex;
    gap:7px;
    align-items:center;
    margin-bottom:10px;
...
#intranet-authority-reconciliation-term {
    flex:1;
    min-width:0;
    padding:8px 9px;
...
.intranet-authority-reconciliation-state {
    font-size:12px;
    color:#475467;
    margin:3px 0 10px 0;
    min-height:17px;
...
.intranet-authority-reconciliation-source-grid {
    display:grid;
    grid-template-columns:1fr;
    gap:10px;
}

.intranet-authority-reconciliation-box {
    background:#fff;
...
.intranet-authority-reconciliation-box-head {
    display:flex;
    justify-content:space-between;
    align-items:center;
    gap:8px;
...
.intranet-authority-reconciliation-box-head strong {
    font-size:13px;
}

.intranet-authority-reconciliation-box-body {
    padding:9px 10px;
}

.intranet-authority-reconciliation-result {
    padding:10px 0;
    border-top:1px solid #edf0f2;
}

.intranet-authority-reconciliation-result:first-child {
    border-top:0;
    padding-top:0;
}

.intranet-authority-reconciliation-wd-layout {
    display:grid;
...
.intranet-authority-reconciliation-photo,.intranet-authority-reconciliation-placeholder {
    width:76px;
    height:98px;
...
.intranet-authority-reconciliation-result-name {
    font-size:14px;
    font-weight:800;
    color:#111827;
    line-height:1.25;
...
.intranet-authority-reconciliation-desc {
    font-size:12px;
    color:#667085;
    line-height:1.35;
    margin-top:3px;
...
.intranet-authority-reconciliation-id {
...
.intranet-authority-reconciliation-meta {
    font-size:12px;
    color:#344054;
    line-height:1.4;
    margin-top:4px;
...
.intranet-authority-reconciliation-meta strong {
    color:#111827;
}

.intranet-authority-reconciliation-actions {
    display:flex;
    gap:6px;
    flex-wrap:wrap;
    margin-top:7px;
...
.intranet-authority-reconciliation-empty,.intranet-authority-reconciliation-error,.intranet-authority-reconciliation-loading {
    padding:9px;
    color:#667085;
    font-size:12px;
}

.intranet-authority-reconciliation-error {
    color:#b42318;
    background:#fff6f5;
...
.intranet-authority-reconciliation-card {
    background:#fff;
    border:1px solid #d8dee6;
    border-radius:8px;
    overflow:hidden;
...
.intranet-authority-reconciliation-card-main {
    display:grid;
...
.intranet-authority-reconciliation-card-photo,.intranet-authority-reconciliation-card-placeholder {
    width:112px;
    height:146px;
    border:1px solid #d8dee6;
    border-radius:5px;
...
.intranet-authority-reconciliation-card-name {
    font-size:22px;
    line-height:1.08;
    font-weight:900;
    color:#0f172a;
...
.intranet-authority-reconciliation-card-description {
    font-size:13px;
    color:#475467;
    line-height:1.4;
    margin-top:5px;
...
.intranet-authority-reconciliation-card-qid {
    font-size:12px;
    color:#174b75;
    font-family:ui-monospace,SFMono-Regular,Menlo,monospace;
    margin-top:7px;
...
.intranet-authority-reconciliation-details {
    display:grid;
...
.intranet-authority-reconciliation-detail {
...
.intranet-authority-reconciliation-detail strong {
    display:block;
    color:#111827;
    margin-bottom:2px;
}

.intranet-authority-reconciliation-card-actions {
    display:flex;
    gap:7px;
    flex-wrap:wrap;
    padding:10px 14px;
...
.intranet-authority-reconciliation-local {
    padding:9px 12px;
    border-bottom:1px solid #e5e7eb;
    background:#fbfdff;
    font-size:11px;
...
.intranet-authority-reconciliation-chip {
    display:inline-flex;
    padding:3px 7px;
...
.intranet-authority-reconciliation-newitem {
    margin-top:10px;
    padding-top:9px;
    border-top:1px solid #e5e7eb;
}

.intranet-authority-reconciliation-card-viaf {
    padding:10px 14px;
    border-top:1px solid #e5e7eb;
    background:#fbfdff;
}

.intranet-authority-reconciliation-warning {
    margin:10px 14px 0;
    padding:8px 9px;
...
.intranet-authority-reconciliation-search-actions {
    margin-top:-2px;
    margin-bottom:10px;
}

.intranet-authority-reconciliation-graph-slot {
    margin:0 0 11px 0;
}

.intranet-authority-reconciliation-graph-toggle {
    display:flex;
    align-items:center;
    justify-content:space-between;
    gap:10px;
...
.intranet-authority-reconciliation-graph-toggle-copy {
    min-width:0;
}

.intranet-authority-reconciliation-graph-toggle-title {
    display:block;
    font-size:13px;
    font-weight:850;
    color:#111827;
...
.intranet-authority-reconciliation-graph-toggle-sub {
    display:block;
    font-size:11px;
    color:#667085;
    margin-top:2px;
...
.intranet-authority-reconciliation-kp {
    background:#fff;
    border:1px solid #d8dee6;
    border-radius:12px;
    overflow:hidden;
...
.intranet-authority-reconciliation-kp-gallery {
    display:grid;
...
.intranet-authority-reconciliation-kp-gallery-item {
    position:relative;
    overflow:hidden;
    background:#e8edf3;
    display:block;
...
.intranet-authority-reconciliation-kp-gallery-item:first-child {
    grid-column:1;
    grid-row:1/3;
}

.intranet-authority-reconciliation-kp-gallery-item:nth-child(2) {
    grid-column:2;
    grid-row:1;
}

.intranet-authority-reconciliation-kp-gallery-item:nth-child(3) {
    grid-column:3;
    grid-row:1;
}

.intranet-authority-reconciliation-kp-gallery-item:nth-child(4) {
    grid-column:2;
    grid-row:2;
}

.intranet-authority-reconciliation-kp-gallery-item:nth-child(5) {
    grid-column:3;
    grid-row:2;
}

.intranet-authority-reconciliation-kp-gallery-item img {
    width:100%;
    height:100%;
    object-fit:cover;
...
.intranet-authority-reconciliation-kp-gallery-item:first-child img {
    object-position:center top;
}

.intranet-authority-reconciliation-kp-gallery-item:hover img {
    transform:scale(1.025);
}

.intranet-authority-reconciliation-kp-gallery-empty {
    display:flex;
    align-items:center;
    justify-content:center;
    min-height:180px;
...
.intranet-authority-reconciliation-kp-main {
    padding:15px 16px 4px;
    background:linear-gradient(135deg,#fff 0%,#f8fbfd 100%);
}

.intranet-authority-reconciliation-kp-name {
    font-size:26px;
    line-height:1.05;
    font-weight:900;
    color:#111827;
...
.intranet-authority-reconciliation-kp-desc {
    font-size:13px;
    color:#475467;
    line-height:1.45;
    margin-top:6px;
...
.intranet-authority-reconciliation-kp-facts-text {
...
.intranet-authority-reconciliation-kp-fact-line {
    margin-top:5px;
}

.intranet-authority-reconciliation-kp-fact-line:first-child {
    margin-top:0;
}

.intranet-authority-reconciliation-kp-fact-line b {
    color:#111827;
}

.intranet-authority-reconciliation-kp-section {
    padding:12px 16px;
    border-top:1px solid #e5e7eb;
}

.intranet-authority-reconciliation-kp-section-title {
    font-size:13px;
    font-weight:850;
    color:#111827;
    margin-bottom:7px;
...
.intranet-authority-reconciliation-kp-wiki {
    font-size:12.5px;
    color:#344054;
    line-height:1.55;
}

.intranet-authority-reconciliation-kp-wiki p {
    margin:0;
}

.intranet-authority-reconciliation-kp-wiki a {
    display:inline;
    margin-left:4px;
    font-weight:750;
    color:#1769aa;
...
.intranet-authority-reconciliation-kp-wiki a:hover {
    text-decoration:underline;
}

.intranet-authority-reconciliation-kp-ids {
    display:flex;
    gap:6px;
    flex-wrap:wrap;
}

.intranet-authority-reconciliation-kp-idbtn {
    display:inline-flex;
    align-items:center;
    gap:5px;
    padding:4px 7px;
...
.intranet-authority-reconciliation-kp-idbtn:hover {
    background:#eef4f8;
    border-color:#aebdca;
    text-decoration:none!important;
}

.intranet-authority-reconciliation-kp-idbtn span {
    font-family:ui-monospace,SFMono-Regular,Menlo,monospace;
    font-weight:600;
    color:#174b75;
}

.intranet-authority-reconciliation-kp-aliases {
    font-size:12px;
    color:#475467;
    line-height:1.5;
}
...
@media(max-width:800px) {
    .intranet-authority-reconciliation-kp-gallery{grid-template-columns:1.45fr 1fr 1fr;grid-template-rows:96px 96px;gap:4px}
    .intranet-authority-reconciliation-kp-gallery-item:first-child{grid-column:1;grid-row:1/3}
    .intranet-authority-reconciliation-kp-gallery-item:nth-child(2){grid-column:2;grid-row:1}
    .intranet-authority-reconciliation-kp-gallery-item:nth-child(3){grid-column:3;grid-row:1}
    .intranet-authority-reconciliation-kp-gallery-item:nth-child(4){grid-column:2;grid-row:2}
    .intranet-authority-reconciliation-kp-gallery-item:nth-child(5){grid-column:3;grid-row:2}
    .intranet-authority-reconciliation-kp-name{font-size:20px}
    body.intranet-authority-reconciliation-docked{padding-left:0!important}
    #intranet-authority-reconciliation-root{width:calc(100vw - 34px);min-width:0;max-width:none}
    .intranet-authority-reconciliation-card-main{grid-template-columns:86px 1fr}
    .intranet-authority-reconciliation-card-photo,.intranet-authority-reconciliation-card-placeholder{width:86px;height:112px}
    .intranet-authority-reconciliation-details{grid-template-columns:1fr}
    .intranet-authority-reconciliation-card-name{font-size:18px}
}
...
/* ============================================================
   ...
   ============================================================ */
.intranet-authority-reconciliation-accordion{margin:0 0 7px;background:#fff}
.intranet-authority-reconciliation-accordion-toggle{
...
.intranet-authority-reconciliation-accordion-toggle:hover{background:#eef3f6;border-color:#bccbd7}
.intranet-authority-reconciliation-accordion-toggle:focus-visible{box-shadow:0 0 0 2px rgba(36,96,137,.18)}
.intranet-authority-reconciliation-accordion.is-open>.intranet-authority-reconciliation-accordion-toggle{background:#edf3f7;border-color:#b7c7d3;border-left:4px solid #336d96;padding-left:9px;border-radius:5px 5px 0 0}
.intranet-authority-reconciliation-accordion-copy{display:flex;flex-direction:column;gap:2px;min-width:0}
.intranet-authority-reconciliation-accordion-title{font-size:13px;font-weight:750;color:#263746;line-height:1.3}
.intranet-authority-reconciliation-accordion-sub{font-size:11px;font-weight:500;color:#71808e;line-height:1.3}
.intranet-authority-reconciliation-accordion-sub:empty{display:none}
.intranet-authority-reconciliation-accordion-chevron{width:18px;height:18px;flex:0 0 18px;position:relative}
.intranet-authority-reconciliation-accordion-chevron:before{content:"";position:absolute;width:7px;height:7px;left:4px;top:3px;border-right:2px solid #667786;border-bottom:2px solid #667786;transform:rotate(45deg);transition:transform .16s ease,top .16s ease}
.intranet-authority-reconciliation-accordion.is-open .intranet-authority-reconciliation-accordion-chevron:before{transform:rotate(225deg);top:7px}
.intranet-authority-reconciliation-accordion-body{padding:12px 10px 16px;border:1px solid #d8e0e7;border-top:0;border-radius:0 0 5px 5px;background:#fff}
.intranet-authority-reconciliation-accordion:not(.is-open) .intranet-authority-reconciliation-accordion-body{display:none}

/* Variantes 400 apresentadas junto dos resultados Wikidata. */
.intranet-authority-reconciliation-variants-list{display:flex;flex-direction:column;gap:5px;margin-top:8px}
.intranet-authority-reconciliation-variant-row{display:flex;gap:12px;align-items:center;justify-content:space-between;padding:6px 0;border-top:1px solid #eef1f5}
.intranet-authority-reconciliation-variant-name{font-size:12px;line-height:1.35;min-width:0;flex:1 1 auto}
.intranet-authority-reconciliation-result-main-actions{margin-top:9px;margin-bottom:12px}
.intranet-authority-reconciliation-add-400{flex:0 0 auto;margin-left:14px!important;padding:4px 7px!important;font-size:11px!important;white-space:nowrap}
.intranet-authority-reconciliation-result-variants{margin-top:10px;padding-top:9px;border-top:1px solid #eef1f5}
.intranet-authority-reconciliation-result-variants-title{font-size:10px;text-transform:uppercase;letter-spacing:.04em;color:#7a8494;margin-bottom:4px;font-weight:700}

/* ============================================================
   OBRAS NO CATÁLOGO
   Lista vertical integral; metadados essenciais em vez do ISBD completo.
   ============================================================ */
.intranet-authority-reconciliation-works-toolbar{position:sticky;top:0;z-index:2;background:#fff;padding:0 0 8px;margin-bottom:2px}
.intranet-authority-reconciliation-works-meta{font-size:11px;color:#7a8793;margin-bottom:6px}
.intranet-authority-reconciliation-works-filter{width:100%;border:1px solid #cfd6df;border-radius:4px;padding:6px 8px;font-size:11.5px;background:#fff}
.intranet-authority-reconciliation-works-list{max-height:560px;overflow-y:auto;overflow-x:hidden;scrollbar-gutter:stable;padding-right:5px}
.intranet-authority-reconciliation-work{display:grid;grid-template-columns:68px minmax(0,1fr);gap:12px;padding:12px 2px;border-bottom:1px solid #e5e9ed;min-width:0}
.intranet-authority-reconciliation-work:last-child{border-bottom:0}
.intranet-authority-reconciliation-work-cover{width:68px;height:102px;object-fit:cover;object-position:center top;border-radius:3px;background:#f1f5f9;box-shadow:0 1px 2px rgba(0,0,0,.08)}
.intranet-authority-reconciliation-work-placeholder{width:68px;height:102px;border-radius:3px;background:#f1f5f9;display:flex;align-items:center;justify-content:center;color:#98a2b3;font-size:9px;text-align:center;padding:5px}
.intranet-authority-reconciliation-work-body{min-width:0}
.intranet-authority-reconciliation-work-title{font-size:13.5px;font-weight:780;line-height:1.35;margin:0 0 7px;color:#1f3f58}
.intranet-authority-reconciliation-work-title a{color:#1f5f8b!important;text-decoration:none!important}
.intranet-authority-reconciliation-work-title a:hover{text-decoration:underline!important}
.intranet-authority-reconciliation-work-details{font-size:11.5px;color:#465766;line-height:1.42}
.intranet-authority-reconciliation-work-line{display:flex;align-items:flex-start;gap:6px;margin-top:3px;min-width:0}
.intranet-authority-reconciliation-work-line:first-child{margin-top:0}
.intranet-authority-reconciliation-work-label{flex:0 0 68px;color:#657786;font-weight:700}
.intranet-authority-reconciliation-work-value{min-width:0;overflow-wrap:anywhere}
.intranet-authority-reconciliation-work-details.is-loading{color:#98a2b3;font-style:italic}
.intranet-authority-reconciliation-works-actions{margin-top:8px;font-size:11px}
.intranet-authority-reconciliation-works-hidden{display:none!important}


/* ============================================================
   OBRAS NO CATÁLOGO · K●RE SIMPLIFICADO · UX v4.5
   ============================================================ */
.intranet-authority-reconciliation-kore-kpis{
    display:grid;
    grid-template-columns:repeat(3,minmax(0,1fr));
    gap:7px;
    margin:0 0 11px;
}
.intranet-authority-reconciliation-kore-kpi{
...
.intranet-authority-reconciliation-kore-kpi:hover{
    background:#f8fafc!important;
    border-color:#b9c5cf;
}
.intranet-authority-reconciliation-kore-kpi.is-active{
    border-color:#8aa8bd;
    background:#f7fafc!important;
    box-shadow:0 0 0 1px rgba(82,103,122,.08);
}
.intranet-authority-reconciliation-kore-kpi-icon{
    width:30px;
    height:30px;
    flex:0 0 30px;
    border-radius:50%;
...
.intranet-authority-reconciliation-kore-kpi.is-critical .intranet-authority-reconciliation-kore-kpi-icon,
.intranet-authority-reconciliation-kore-kpi.is-review .intranet-authority-reconciliation-kore-kpi-icon,
.intranet-authority-reconciliation-kore-kpi.is-info .intranet-authority-reconciliation-kore-kpi-icon{
    background:#f2f4f7;
    color:#667085;
}
.intranet-authority-reconciliation-kore-kpi-copy{
    display:flex;
    flex-direction:column;
    min-width:0;
}
.intranet-authority-reconciliation-kore-kpi-copy strong{
    font-size:18px;
    line-height:1;
    font-weight:800;
    color:#1d2939;
}
.intranet-authority-reconciliation-kore-kpi-copy span{
    font-size:10.5px;
    line-height:1.25;
    color:#667085;
    margin-top:4px;
...
.intranet-authority-reconciliation-kore-note{
    font-size:10.5px;
    color:#667085;
    line-height:1.4;
    margin:0 0 8px;
}
.intranet-authority-reconciliation-works-toolbar{
    margin-bottom:5px;
}
.intranet-authority-reconciliation-kore-work{
    display:grid;
...
.intranet-authority-reconciliation-kore-work:last-child{border-bottom:0}
.intranet-authority-reconciliation-kore-cover{min-width:0}
.intranet-authority-reconciliation-kore-main{min-width:0}
.intranet-authority-reconciliation-kore-actions{
    display:flex;
    flex-direction:column;
    align-items:stretch;
    gap:6px;
...
.intranet-authority-reconciliation-kore-action{
...
.intranet-authority-reconciliation-kore-action:hover{
    background:#f8fafc!important;
...
.intranet-authority-reconciliation-kore-problems{
    display:flex;
    flex-wrap:wrap;
    gap:5px;
    margin-top:7px;
}
.intranet-authority-reconciliation-kore-badge{
    display:inline-flex;
    align-items:center;
    gap:4px;
    padding:4px 7px;
...
.intranet-authority-reconciliation-kore-badge.is-critical{
    border-color:#fecdca;
    background:#fff5f5;
    color:#b42318;
}
.intranet-authority-reconciliation-kore-badge.is-review{
    border-color:#fedf89;
    background:#fffaeb;
    color:#b54708;
}
.intranet-authority-reconciliation-kore-badge.is-info{
    border-color:#b2ddff;
    background:#eff8ff;
    color:#175cd3;
}
.intranet-authority-reconciliation-kore-diagnostics{
    margin-top:8px;
    display:flex;
    flex-direction:column;
    gap:5px;
}
.intranet-authority-reconciliation-kore-diagnostic{
    padding:7px 8px;
...
.intranet-authority-reconciliation-kore-diagnostic.is-critical{border-left-color:#f04438}
.intranet-authority-reconciliation-kore-diagnostic.is-review{border-left-color:#f79009}
.intranet-authority-reconciliation-kore-diagnostic.is-info{border-left-color:#2e90fa}
.intranet-authority-reconciliation-kore-diagnostic strong{
    display:block;
    color:#344054;
    font-weight:800;
}
.intranet-authority-reconciliation-kore-diagnostic span{
    display:block;
    color:#667085;
    margin-top:2px;
}
.intranet-authority-reconciliation-kore-more{
    margin-top:5px;
    font-size:10px;
    color:#667085;
}

.intranet-authority-reconciliation-work-details{
    margin-top:5px;
}
.intranet-authority-reconciliation-work-meta{
    display:grid;
...
.intranet-authority-reconciliation-work-meta-label{
    color:#52677a;
    font-weight:700;
}
.intranet-authority-reconciliation-work-meta-value{
    color:#344054;
    min-width:0;
}

.intranet-authority-reconciliation-kore-empty{
    padding:11px;
...
.intranet-authority-reconciliation-works-analysis-warning{
    margin-top:8px;
    color:#854a0e;
    background:#fffaeb;
    border:1px solid #fedf89;
...
.intranet-authority-reconciliation-marc-modal{
    position:fixed;
    inset:0;
    z-index:100000;
    display:flex;
...
.intranet-authority-reconciliation-marc-dialog{
...
.intranet-authority-reconciliation-marc-head{
    min-height:46px;
    padding:10px 14px;
    display:flex;
    align-items:center;
...
.intranet-authority-reconciliation-marc-title{
    font-size:14px;
    font-weight:800;
    color:#344054;
}
.intranet-authority-reconciliation-marc-close{
...
.intranet-authority-reconciliation-marc-close:hover{background:#f2f4f7;color:#344054}
.intranet-authority-reconciliation-marc-frame{
    width:100%;
    height:100%;
    flex:1 1 auto;
    border:0;
...
@media(max-width:700px){
    .intranet-authority-reconciliation-kore-kpis{grid-template-columns:repeat(2,minmax(0,1fr))}
    .intranet-authority-reconciliation-kore-work{grid-template-columns:68px minmax(0,1fr)}
    .intranet-authority-reconciliation-kore-actions{
        grid-column:2;
        flex-direction:row;
        flex-wrap:wrap;
    ...
    .intranet-authority-reconciliation-kore-primary-action{width:auto}
    .intranet-authority-reconciliation-kore-secondary-actions{
        flex-direction:row;
        flex-wrap:wrap;
    }
}
...
.intranet-authority-reconciliation-toolbar-spaced { margin-top: 10px; }
.intranet-authority-reconciliation-box-head-flush { padding-left: 0; padding-right: 0; }
.intranet-authority-reconciliation-create-trigger { padding: 0 10px 10px; }
.intranet-authority-reconciliation-box-spaced { margin-top: 10px; }
.intranet-authority-reconciliation-desc-spaced { margin-top: 8px; }
`;

    function instalarEstilos() {
        if (document.getElementById("intranet-authority-reconciliation-styles")) return;

        var style = document.createElement("style");
        style.id = "intranet-authority-reconciliation-styles";
        style.type = "text/css";
        style.textContent = INTRANET_AUTHORITY_RECONCILIATION_CSS;
    ...
    $(document).ready(function () {
        ...
        var CONFIG = {
            ...
            storageKeyLargura: "intranet-authority-reconciliation-panel-width",
            idiomaPrincipal: "pt",
        ...
        function sincronizarInterfaceInicial() {
            ...
            if ($("#intranet-authority-reconciliation-term").length) $("#intranet-authority-reconciliation-term").val(authority.nome || "");
        ...
        /** Cria a estrutura HTML do módulo. Os estilos estão concentrados no bloco INTRANET_AUTHORITY_RECONCILIATION_CSS. */
        function instalarInterface() {
            $("#intranet-authority-reconciliation-root, #intranet-authority-reconciliation-tab").remove();
            $("body").removeClass("intranet-authority-reconciliation-docked intranet-authority-reconciliation-resizing");
            document.documentElement.style.removeProperty("--intranet-authority-reconciliation-dock-width");

            var html = '' +
                '<aside id="intranet-authority-reconciliation-root" aria-hidden="true">' +
                    '<div class="intranet-authority-reconciliation-head">' +
                        '<div class="intranet-authority-reconciliation-brand"><strong id="intranet-authority-reconciliation-heading">AuthID #</strong></div>' +
                        '<button type="button" class="intranet-authority-reconciliation-close" id="intranet-authority-reconciliation-close" aria-label="Fechar">×</button>' +
                    '</div>' +
                    '<div class="intranet-authority-reconciliation-body" id="intranet-authority-reconciliation-body"></div>' +
                    '<div id="intranet-authority-reconciliation-resizer" role="separator" aria-orientation="vertical" aria-label="Redimensionar painel Identificadores" tabindex="0"></div>' +
                '</aside>';
        ...
        function instalarBotaoAbertura() {
             ...
             */
            var $botao = $('<button type="button" id="intranet-authority-reconciliation-tab" aria-controls="intranet-authority-reconciliation-root" aria-expanded="false" aria-label="Abrir Identificadores" title="Abrir Identificadores">››</button>');
            $("body").append($botao);
        }


        function alinharBotaoComTitulo() {
            var tab = document.getElementById("intranet-authority-reconciliation-tab");
            if (!tab) return;
             ...
             */
            if (tab.dataset.intranetAuthorityReconciliationFixedTop) {
                tab.style.top = tab.dataset.intranetAuthorityReconciliationFixedTop;
                return;
            }
            ...
            var fixedTop = top + "px";
            tab.dataset.intranetAuthorityReconciliationFixedTop = fixedTop;
        ...
        function abrirPainel() {
            STATE.aberto = true;
            $("#intranet-authority-reconciliation-root").addClass("intranet-authority-reconciliation-open").attr("aria-hidden", "false");
            $("#intranet-authority-reconciliation-tab").attr("aria-expanded", "true").hide();
            aplicarDockLayout();
            atualizarAuthorityState();
            atualizarResumoLateral();
        ...
        function fecharPainel() {
            ...
            $("#intranet-authority-reconciliation-root")
                .removeClass("intranet-authority-reconciliation-open")
                .attr("aria-hidden", "true");

            /*
             * Primeiro retiramos o dock. Só depois mostramos e recolocamos o botão.
             * Desta forma nenhuma regra de body.intranet-authority-reconciliation-docked consegue deixar
             * o botão na posição deslocada do painel.
             */
            removerDockLayout();

            var $tab = $("#intranet-authority-reconciliation-tab");
        ...
        function obterLarguraInicialPainel() {
            ...
            var root = document.getElementById("intranet-authority-reconciliation-root");
        ...
        function definirLarguraPainel(px, persistir) {
            ...
            document.documentElement.style.setProperty("--intranet-authority-reconciliation-dock-width", px + "px");
            ...
            if (STATE.aberto && !window.matchMedia("(max-width: 800px)").matches) {
                $("body").addClass("intranet-authority-reconciliation-docked");
            }
        }
        ...
        function iniciarRedimensionamento(e) {
            ...
            $("body").addClass("intranet-authority-reconciliation-resizing");
        ...
        function terminarRedimensionamento(e) {
            if (!STATE.redimensionando) return;
            STATE.redimensionando = false;
            $("body").removeClass("intranet-authority-reconciliation-resizing");
            definirLarguraPainel(STATE.larguraPainelPx, true);

            try {
                var handle = document.getElementById("intranet-authority-reconciliation-resizer");
        ...
        function atualizarResumoLateral() {
            ...
            $("#intranet-authority-reconciliation-heading").text("AuthID #" + (a.authid || "—"));
        }
        ...
        function renderModoPesquisa() {
            ...
            var pesquisa = '' +
                '<div class="intranet-authority-reconciliation-searchbar"><input type="text" id="intranet-authority-reconciliation-term" autocomplete="off" placeholder="Nome da autoridade"></div>' +
                '<div class="intranet-authority-reconciliation-toolbar intranet-authority-reconciliation-search-actions"><button type="button" class="intranet-authority-reconciliation-btn intranet-authority-reconciliation-primary" id="intranet-authority-reconciliation-search">Pesquisar Wikidata + VIAF</button></div>' +
                '<div class="intranet-authority-reconciliation-state" id="intranet-authority-reconciliation-state">Confirme sempre a identidade antes de aplicar um identificador.</div>' +
                '<div class="intranet-authority-reconciliation-source-grid">' +
                    '<section class="intranet-authority-reconciliation-box"><div class="intranet-authority-reconciliation-box-head"><strong>Wikidata</strong></div><div class="intranet-authority-reconciliation-box-body" id="intranet-authority-reconciliation-wikidata"><div class="intranet-authority-reconciliation-empty">Aguardando pesquisa.</div></div><div id="intranet-authority-reconciliation-create-area"></div></section>' +
                    '<section class="intranet-authority-reconciliation-box"><div class="intranet-authority-reconciliation-box-head"><strong>VIAF</strong></div><div class="intranet-authority-reconciliation-box-body" id="intranet-authority-reconciliation-viaf"><div class="intranet-authority-reconciliation-empty">Aguardando pesquisa.</div></div></section>' +
                '</div>';

            var html = '';
            if (qid) {
                html += criarAccordion('graph', 'Painel de Identidade', 'Wikidata, Wikimedia Commons e Wikipedia', false,
                    '<div id="intranet-authority-reconciliation-graph-area" class="intranet-authority-reconciliation-graph-slot" data-qid="' + escaparAttr(qid) + '"></div>');
            }
            ...
            html += criarAccordion('works', 'Obras no catálogo', '', false,
                '<div id="intranet-authority-reconciliation-works"><div class="intranet-authority-reconciliation-empty">A verificar obras ligadas…</div></div>');

            $("#intranet-authority-reconciliation-body").html(html);
        ...
        function criarAccordion(id, titulo, subtitulo, aberto, conteudo) {
            return '<section class="intranet-authority-reconciliation-accordion' + (aberto ? ' is-open' : '') + '" data-accordion="' + escaparAttr(id) + '">' +
                '<div class="intranet-authority-reconciliation-accordion-toggle" role="button" tabindex="0" aria-expanded="' + (aberto ? 'true' : 'false') + '">' +
                    '<span class="intranet-authority-reconciliation-accordion-copy"><span class="intranet-authority-reconciliation-accordion-title">' + escaparHTML(titulo) + '</span><span class="intranet-authority-reconciliation-accordion-sub">' + escaparHTML(subtitulo || '') + '</span></span>' +
                    '<span class="intranet-authority-reconciliation-accordion-chevron" aria-hidden="true"></span>' +
                '</div>' +
                '<div class="intranet-authority-reconciliation-accordion-body">' + conteudo + '</div>' +
            '</section>';
        }
        ...
        function renderFichaAutoridade(entidade, qid) {
            ...
            var $area = $("#intranet-authority-reconciliation-graph-area");
            if (!$area.length) return;
            $area.html('<div class="intranet-authority-reconciliation-loading">A construir Painel de Identidade…</div>');
            ...
            obterLabelsEntidades(relatedIds, function (labelsMap) {
                if (STATE.qidAtual !== qid || !$("#intranet-authority-reconciliation-graph-area").length) return;
                ...
                function factLine(t, v) {
                    return v ? '<div class="intranet-authority-reconciliation-kp-fact-line"><b>' + escaparHTML(t) + ':</b> ' + escaparHTML(v) + '</div>' : '';
                }
                function idButton(t, v, url) {
                    if (!v || !url) return '';
                    return '<a class="intranet-authority-reconciliation-kp-idbtn" href="' + escaparAttr(url) + '" target="_blank" rel="noopener noreferrer" title="Abrir ' + escaparAttr(t) + '"><b>' + escaparHTML(t) + '</b><span>' + escaparHTML(v) + '</span></a>';
                }

                var html = '<div class="intranet-authority-reconciliation-kp">';
                html += '<div id="intranet-authority-reconciliation-kp-gallery" class="intranet-authority-reconciliation-kp-gallery"><div class="intranet-authority-reconciliation-kp-gallery-empty">A carregar imagens do Wikimedia Commons…</div></div>';
                html += '<div class="intranet-authority-reconciliation-kp-main"><div class="intranet-authority-reconciliation-kp-name">' + escaparHTML(label) + '</div>';
                if (descricao) html += '<div class="intranet-authority-reconciliation-kp-desc">' + escaparHTML(descricao) + '</div>';
                html += '</div>';
                ...
                if (facts) html += '<div class="intranet-authority-reconciliation-kp-facts-text">' + facts + '</div>';

                html += '<div class="intranet-authority-reconciliation-kp-section" id="intranet-authority-reconciliation-kp-wikipedia"><div class="intranet-authority-reconciliation-kp-wiki">A carregar resumo…</div></div>';

                if (aliases.length) html += '<div class="intranet-authority-reconciliation-kp-section"><div class="intranet-authority-reconciliation-kp-section-title">Outros nomes</div><div class="intranet-authority-reconciliation-kp-aliases">' + escaparHTML(aliases.join(' · ')) + '</div></div>';
                ...
                if (idsHtml) html += '<div class="intranet-authority-reconciliation-kp-section"><div class="intranet-authority-reconciliation-kp-section-title">Identificadores</div><div class="intranet-authority-reconciliation-kp-ids">' + idsHtml + '</div></div>';

                if (viafLocal && viafWd && viafLocal !== viafWd) {
                    html += '<div class="intranet-authority-reconciliation-warning"><strong>Atenção:</strong> o VIAF do 017 (' + escaparHTML(viafLocal) + ') difere do VIAF indicado no Wikidata (' + escaparHTML(viafWd) + ').</div>';
                }

                html += '</div>';
                $("#intranet-authority-reconciliation-graph-area").html(html);
        ...
        function carregarGaleriaCommons(entidade, label) {
            var $galeria = $("#intranet-authority-reconciliation-kp-gallery");
            ...
            var req = $.ajax({
                ...
                if (!$("#intranet-authority-reconciliation-kp-gallery").length) return;
                var imagens = [];
                var vistos = {};
                ...
                if (!imagens.length) {
                    $galeria.html('<div class="intranet-authority-reconciliation-kp-gallery-empty">Sem imagens adicionais no Wikimedia Commons.</div>');
                    return;
                }

                var html = '';
                imagens.forEach(function (img) {
                    html += '<a class="intranet-authority-reconciliation-kp-gallery-item" href="' + escaparAttr(img.page) + '" target="_blank" rel="noopener noreferrer" title="Abrir imagem no Wikimedia Commons"><img src="' + escaparAttr(img.url) + '" alt="' + escaparAttr(label) + '"></a>';
                });
                $galeria.html(html);
            }).fail(function () {
                if (!$("#intranet-authority-reconciliation-kp-gallery").length) return;
                if (principalUrl) {
                    $galeria.html('<a class="intranet-authority-reconciliation-kp-gallery-item" href="' + escaparAttr(principalPage) + '" target="_blank" rel="noopener noreferrer"><img src="' + escaparAttr(principalUrl) + '" alt="' + escaparAttr(label) + '"></a>');
                } else {
                    $galeria.html('<div class="intranet-authority-reconciliation-kp-gallery-empty">Sem imagens disponíveis.</div>');
                }
            });
            registarPedido(req);
        }
        ...
        function carregarResumoWikipedia(entidade) {
            var $sec = $("#intranet-authority-reconciliation-kp-wikipedia");
            ...
            var req = $.ajax({
                ...
                if (!$("#intranet-authority-reconciliation-kp-wikipedia").length) return;
                ...
                $sec.html('<div class="intranet-authority-reconciliation-kp-wiki"><p>' + escaparHTML(resumo) + ' <a href="' + escaparAttr(link) + '" target="_blank" rel="noopener noreferrer">Ler mais</a></p></div>');
            }).fail(function () {
                if (!$("#intranet-authority-reconciliation-kp-wikipedia").length) return;
                $sec.html('<div class="intranet-authority-reconciliation-kp-wiki"><a href="' + escaparAttr(ref.url) + '" target="_blank" rel="noopener noreferrer">Ler mais</a></div>');
            });
            registarPedido(req);
        }
        ...
        function tentarCriarNovo400(callback) {
            ...
            if (!$gatilho.length) {
                console.warn("Authority Reconciliation: não foi localizado o controlo nativo para repetir o campo 400.");
                callback(null);
                return;
            }
            ...
            try {
                ...
                console.warn("Authority Reconciliation: não foi possível acionar a repetição do campo 400", e);
                callback(null);
                return;
            }
        ...
        function carregarGrafoAccordion() {
            var $area=$("#intranet-authority-reconciliation-graph-area"); if (!$area.length || $area.children().length) return;
            atualizarAuthorityState();
            ...
            $area.html('<div class="intranet-authority-reconciliation-loading">A carregar Painel de Identidade…</div>');
            carregarEntidadeWikidata(qid,function(entidade){
                if(!entidade){$area.html('<div class="intranet-authority-reconciliation-error">Não foi possível carregar a entidade Wikidata.</div>');return;}
        ...
        function linhaObra(rotulo, valor) {
            ...
            if (!valor) return '';
            return '<div class="intranet-authority-reconciliation-work-line"><span class="intranet-authority-reconciliation-work-label">' + escaparHTML(rotulo) + '</span><span class="intranet-authority-reconciliation-work-value">' + escaparHTML(valor) + '</span></div>';
        }
        ...
        function koreLiteRenderKpis(obras) {
            ...
            return '<div class="intranet-authority-reconciliation-kore-kpis">' +
                defs.map(function (d) {
                    var n = koreLiteContar(obras, d.key);
                    if (d.key !== "todos" && !n) return "";
                    return '<button type="button" class="intranet-authority-reconciliation-kore-kpi ' + d.cls +
                        (STATE.obrasFiltroProblema === d.key ? ' is-active' : '') +
                        '" data-kore-filter="' + escaparAttr(d.key) + '">' +
                        '<span class="intranet-authority-reconciliation-kore-kpi-icon"><i class="fa ' + escaparAttr(d.icon) + '"></i></span>' +
                        '<span class="intranet-authority-reconciliation-kore-kpi-copy"><strong>' + n + '</strong><span>' + escaparHTML(d.label) + '</span></span>' +
                    '</button>';
                }).join("") +
            '</div>';
        }
        ...
        function koreLiteRenderDiagnosticos(obra) {
            ...
            return '<div class="intranet-authority-reconciliation-kore-diagnostics">' +
                problemas.map(function (p) {
                    return '<div class="intranet-authority-reconciliation-kore-diagnostic ' + koreLiteClasse(p.tipo) + '">' +
        ...
        function renderObrasCatalogo(obras, urlPesquisa) {
            var $alvo = $('#intranet-authority-reconciliation-works');
            ...
            if (!obras.length) {
                if (STATE.obrasNaoAnalisadas) {
                    $alvo.html(
                        '<div class="intranet-authority-reconciliation-works-analysis-warning">' +
                    ...
                    $alvo.html('<div class="intranet-authority-reconciliation-kore-empty">Não foram encontrados problemas nas obras associadas a esta autoridade.</div>');
                }
                return;
            }
            ...
            var html =
                ...
                '<div class="intranet-authority-reconciliation-kore-note">Apenas obras que requerem intervenção. O diagnóstico é apresentado diretamente; a ação principal abre o registo para correção.</div>' +
                '<div class="intranet-authority-reconciliation-works-toolbar">' +
                    '<div class="intranet-authority-reconciliation-works-meta">' + obras.length + ' obra' + (obras.length === 1 ? '' : 's') + ' com problema' + (obras.length === 1 ? '' : 's') + '</div>' +
                    '<input type="search" id="intranet-authority-reconciliation-works-filter" class="intranet-authority-reconciliation-works-filter" autocomplete="off" placeholder="Filtrar obras…" value="' + escaparAttr(STATE.obrasFiltroTexto || '') + '">' +
                '</div>' +
                '<div class="intranet-authority-reconciliation-works-list" id="intranet-authority-reconciliation-works-list">';
            ...
            visiveis.forEach(function (o) {
                ...
                html += '<article class="intranet-authority-reconciliation-work intranet-authority-reconciliation-kore-work" data-biblionumber="' + escaparAttr(o.biblionumber) + '">' +

                    '<div class="intranet-authority-reconciliation-kore-cover">' +
                        (o.img
                            ? '<img class="intranet-authority-reconciliation-work-cover" src="' + escaparAttr(o.img) + '" alt="">'
                            : '<div class="intranet-authority-reconciliation-work-placeholder">Sem capa</div>') +
                    '</div>' +

                    '<div class="intranet-authority-reconciliation-kore-main">' +

                        '<div class="intranet-authority-reconciliation-work-title">' +
                            '<a href="' + escaparAttr(detalhe) + '" target="_blank" rel="noopener noreferrer">' +
                                escaparHTML(titulo) +
                            '</a>' +
                        '</div>' +

                        '<div class="intranet-authority-reconciliation-work-details is-loading">A carregar dados bibliográficos…</div>' +

                        koreLiteRenderDiagnosticos(o) +

                    '</div>' +

                    '<div class="intranet-authority-reconciliation-kore-actions">' +

                        '<a class="intranet-authority-reconciliation-kore-action" href="' + escaparAttr(editar) + '" target="_blank" rel="noopener noreferrer">' +
                            '<i class="fa fa-pencil" aria-hidden="true"></i> Editar registo' +
                        '</a>' +

                        '<button type="button" class="intranet-authority-reconciliation-kore-action intranet-authority-reconciliation-open-marc" ' +
            ...
            if (!visiveis.length) {
                html += '<div class="intranet-authority-reconciliation-empty">Não existem obras para o filtro selecionado.</div>';
            }

            html += '</div>';

            if (STATE.obrasNaoAnalisadas) {
                html += '<div class="intranet-authority-reconciliation-works-analysis-warning">' +
        ...
        function carregarDetalhesObra($obra) {
            ...
            var $dest = $obra.find('.intranet-authority-reconciliation-work-details');
            var htmlCache = STATE.obrasDetalheHtml && STATE.obrasDetalheHtml[biblionumber];
            function aplicarHtmlDetalhe(html) {
                    var d = extrairMetadadosObra(html, { titulo: $obra.find('.intranet-authority-reconciliation-work-title').text() });
                    var meta = [];
                    ...
                    function addMeta(label, value) {
                        ...
                        if (!value) return;
                        meta.push(
                            '<span class="intranet-authority-reconciliation-work-meta-label">' + escaparHTML(label) + '</span>' +
                            '<span class="intranet-authority-reconciliation-work-meta-value">' + escaparHTML(value) + '</span>'
                        );
                    }
                    ...
                    $dest.html(
                        meta.length
                            ? '<div class="intranet-authority-reconciliation-work-meta">' + meta.join('') + '</div>'
                            : '<span class="intranet-authority-reconciliation-muted">Sem metadados adicionais disponíveis.</span>'
                    ).removeClass('is-loading');
                    $obra.attr('data-detail-loaded', '1');
                    var filtro = limparTexto(($obra.find('.intranet-authority-reconciliation-work-title').text() || '') + ' ' + $dest.text()).toLowerCase();
            ...
            var req = $.ajax({ url: '/cgi-bin/koha/catalogue/detail.pl?biblionumber=' + encodeURIComponent(biblionumber), dataType: 'html', timeout: CONFIG.timeout })
                ...
                .fail(function () {
                    $dest.html('<span class="intranet-authority-reconciliation-muted">Não foi possível carregar os metadados.</span>').removeClass('is-loading');
                    $obra.attr('data-detail-loaded', '1');
        ...
        function observarDetalhesObrasVisiveis() {
            var root = document.getElementById('intranet-authority-reconciliation-works-list');
            if (!root) return;
            var itens = root.querySelectorAll('.intranet-authority-reconciliation-work[data-biblionumber]');
        ...
        function filtrarObrasCatalogo(valor) {
            ...
            $('#intranet-authority-reconciliation-works-list .intranet-authority-reconciliation-work').each(function () {
                var texto = String($(this).attr('data-filter') || '');
                $(this).toggleClass('intranet-authority-reconciliation-works-hidden', !!termo && texto.indexOf(termo) === -1);
            });
        }
                    ...
                    (function (obra) {
                        ...
                        var req = $.ajax({ url: url, dataType: 'html', timeout: CONFIG.timeout })
                            .done(function (html) {
                                ...
                                if (validacao === true) {
                                    obra.intranetAuthorityReconciliationAutoria = 'confirmada';
                                    aprovadas.push(obra);
                                } else if (validacao === null) {
                                    obra.intranetAuthorityReconciliationAutoria = 'nao-determinada';
                                    naoConfirmadas.push(obra);
                                } else {
                                    obra.intranetAuthorityReconciliationAutoria = 'rejeitada';
        ...
        function atualizarTituloObras(total, estado) {
            var $titulo = $('.intranet-authority-reconciliation-accordion[data-accordion="works"] .intranet-authority-reconciliation-accordion-title').first();
            var $sub = $('.intranet-authority-reconciliation-accordion[data-accordion="works"] .intranet-authority-reconciliation-accordion-sub').first();
        ...
        function precarregarResumoObras() {
            ...
            if (!/^\d+$/.test(authid)) {
                ...
                if ($alvo.length) $alvo.html('<div class="intranet-authority-reconciliation-empty">A autoridade ainda não tem AuthID persistido.</div>');
                return;
            }
            ...
            if (STATE.obrasPrecarregadasAuthid === authid && Array.isArray(STATE.obrasLigadasPreload)) {
                ...
                if ($alvo.length && !STATE.obrasCarregadas) {
                    $alvo.html('<div class="intranet-authority-reconciliation-empty">' + STATE.obrasLigadasPreload.length + ' registo' + (STATE.obrasLigadasPreload.length === 1 ? '' : 's') + ' ligado' + (STATE.obrasLigadasPreload.length === 1 ? '' : 's') + '. Abra a secção para validar a autoria e carregar os detalhes.</div>');
                }
                return;
            }
            ...
            carregarTodasObrasCatalogo(url, function (erro, obras) {
                ...
                if (erro && !obras.length) {
                    ...
                    if ($alvo.length) $alvo.html('<div class="intranet-authority-reconciliation-error">Não foi possível verificar automaticamente os bibliográficos ligados.</div>');
                    return;
                }
                ...
                if ($alvo.length && !STATE.obrasCarregadas) {
                    if (!obras.length) {
                        $alvo.html('<div class="intranet-authority-reconciliation-empty">Não foram encontrados bibliográficos ligados.</div>');
                    } else {
                        $alvo.html('<div class="intranet-authority-reconciliation-empty">' + obras.length + ' registo' + (obras.length === 1 ? '' : 's') + ' ligado' + (obras.length === 1 ? '' : 's') + '. Abra esta secção para validar a autoria e carregar os detalhes.</div>');
                    }
                }
            });
        }
        ...
        function carregarObrasCatalogo() {
            ...
            if (!/^\d+$/.test(authid)) {
                $alvo.html('<div class="intranet-authority-reconciliation-empty">A autoridade ainda não tem AuthID persistido.</div>');
                return;
            }
            ...
            $alvo.html('<div class="intranet-authority-reconciliation-loading">A preparar análise K●RE simplificada…</div>');
            ...
            koreLitePesquisarCandidatos(authid, function (candidatos) {
                ...
                $alvo.html('<div class="intranet-authority-reconciliation-loading">K●RE simplificado · a analisar MARC de ' + candidatos.length + ' registos candidatos…</div>');
                ...
                koreLiteAnalisarObras(candidatos, authid, function (problemas) {
                    ...
                    var detalhe = obraAtual && obraAtual.biblionumber
                        ...
                        : '';
                    $alvo.html('<div class="intranet-authority-reconciliation-loading">K●RE simplificado · ' + feito + '/' + total + ' · ' + encontrados + ' obra' + (encontrados === 1 ? '' : 's') + ' com problema' + detalhe + '</div>');
                });
            });
        }
        ...
        function abrirMarcSobrePagina(url, titulo) {
            ...
            var html =
                '<div class="intranet-authority-reconciliation-marc-modal" id="intranet-authority-reconciliation-marc-modal" role="dialog" aria-modal="true">' +
                    '<div class="intranet-authority-reconciliation-marc-dialog">' +
                        '<div class="intranet-authority-reconciliation-marc-head">' +
                            '<div class="intranet-authority-reconciliation-marc-title">MARC · ' + escaparHTML(titulo || "Registo bibliográfico") + '</div>' +
                            '<button type="button" class="intranet-authority-reconciliation-marc-close" aria-label="Fechar"><i class="fa fa-times" aria-hidden="true"></i></button>' +
                        '</div>' +
                        '<iframe class="intranet-authority-reconciliation-marc-frame" src="' + escaparAttr(url) + '" title="MARC"></iframe>' +
                    '</div>' +
                '</div>';

            $("body").append(html);
            $("body").addClass("intranet-authority-reconciliation-modal-open");
        }

        function fecharMarcSobrePagina() {
            $("#intranet-authority-reconciliation-marc-modal").remove();
            $("body").removeClass("intranet-authority-reconciliation-modal-open");
        }
        ...
        function bindEventos() {
            $(document)
                .off(".intranetAuthorityReconciliationV1")
                .on("click.intranetAuthorityReconciliationV1", "#intranet-authority-reconciliation-tab", function () {
                    if (STATE.aberto) fecharPainel(); else abrirPainel();
                })
                .on("click.intranetAuthorityReconciliationV1", "#intranet-authority-reconciliation-close", fecharPainel)
                .on("pointerdown.intranetAuthorityReconciliationV1", "#intranet-authority-reconciliation-resizer", iniciarRedimensionamento)
                .on("pointermove.intranetAuthorityReconciliationV1", moverRedimensionamento)
                .on("pointerup.intranetAuthorityReconciliationV1 pointercancel.intranetAuthorityReconciliationV1", terminarRedimensionamento)
                .on("keydown.intranetAuthorityReconciliationV1", "#intranet-authority-reconciliation-resizer", redimensionarPorTeclado)
                .on("keydown.intranetAuthorityReconciliationV1", "#intranet-authority-reconciliation-term", function (e) {
                    if (e.key === "Enter") {
                        e.preventDefault();
                        $("#intranet-authority-reconciliation-search").trigger("click");
                    }
                })

                .on("keydown.intranetAuthorityReconciliationV1", ".intranet-authority-reconciliation-accordion-toggle", function (e) {
                    if (e.key !== "Enter" && e.key !== " ") return;
                    e.preventDefault();
                    $(this).trigger("click");
                })
                .on("click.intranetAuthorityReconciliationV1", ".intranet-authority-reconciliation-accordion-toggle", function () {
                    var $acc = $(this).closest(".intranet-authority-reconciliation-accordion");
                ...
                .on("input.intranetAuthorityReconciliationV1", "#intranet-authority-reconciliation-works-filter", function () {
                    STATE.obrasFiltroTexto = $(this).val() || "";
                    renderObrasCatalogo(STATE.obrasProblemas || [], STATE.obrasPesquisaUrl || "");
                })
                .on("click.intranetAuthorityReconciliationV1", ".intranet-authority-reconciliation-open-marc", function (e) {
                    e.preventDefault();
                    e.stopPropagation();
                ...
                .on("click.intranetAuthorityReconciliationV1", ".intranet-authority-reconciliation-marc-close", function (e) {
                    e.preventDefault();
                    fecharMarcSobrePagina();
                })
                .on("click.intranetAuthorityReconciliationV1", "#intranet-authority-reconciliation-marc-modal", function (e) {
                    if (e.target === this) fecharMarcSobrePagina();
                })
                .on("keydown.intranetAuthorityReconciliationV1", function (e) {
                    if (e.key === "Escape" && $("#intranet-authority-reconciliation-marc-modal").length) {
                        fecharMarcSobrePagina();
                    }
                })
                .on("click.intranetAuthorityReconciliationV1", "[data-kore-filter]", function (e) {
                    e.preventDefault();
                    e.stopPropagation();
                    STATE.obrasFiltroProblema = String($(this).attr("data-kore-filter") || "todos");
                    renderObrasCatalogo(STATE.obrasProblemas || [], STATE.obrasPesquisaUrl || "");
                })
                .on("click.intranetAuthorityReconciliationV1", ".intranet-authority-reconciliation-add-400", function (e) {
                    e.preventDefault(); e.stopPropagation();
                    aplicarVariante400(String($(this).attr("data-forma") || ""));
                })
                .on("click.intranetAuthorityReconciliationV1", "#intranet-authority-reconciliation-search", executarPesquisa)
                .on("click.intranetAuthorityReconciliationV1", "#intranet-authority-reconciliation-retry-viaf", function () {
                    var termo = normalizarTermoPesquisa($("#intranet-authority-reconciliation-term").val()) || normalizarTermoPesquisa((STATE.authority && STATE.authority.nome) || "");
                    if (!termo) return;
                    STATE.tokenPesquisa++;
                    pesquisarVIAF(termo, STATE.tokenPesquisa);
                })
                .on("click.intranetAuthorityReconciliationV1", "#intranet-authority-reconciliation-prepare-wikidata", function () { renderAjudaCriacaoWikidata(true); })
                .on("click.intranetAuthorityReconciliationV1", "#intranet-authority-reconciliation-copy-qs", copiarQuickStatements)
                .on("click.intranetAuthorityReconciliationV1", ".intranet-authority-reconciliation-apply", function (e) {
                    e.preventDefault();
                    e.stopPropagation();
                ...
                .on("input.intranetAuthorityReconciliationV1 change.intranetAuthorityReconciliationV1", "input[type='text'], textarea, select", debounce(function () {
                    if ($(this).closest("#intranet-authority-reconciliation-root").length) return;
                    atualizarAuthorityState();
                    atualizarResumoLateral();
                }, 180))
                .on("keydown.intranetAuthorityReconciliationV1", function (e) {
                ...
                .on("resize.intranetAuthorityReconciliationV1", debounce(function () {
                    if (!STATE.aberto) return;
                    if (window.matchMedia && window.matchMedia("(max-width: 800px)").matches) {
                        $("body").removeClass("intranet-authority-reconciliation-docked intranet-authority-reconciliation-resizing");
                        return;
        ...
        function executarPesquisa() {
            atualizarAuthorityState();
            var termo = normalizarTermoPesquisa($("#intranet-authority-reconciliation-term").val());
            ...
            $("#intranet-authority-reconciliation-create-area").empty();
        ...
        function pesquisarWikidata(termo, token) {
            $("#intranet-authority-reconciliation-wikidata").html('<div class="intranet-authority-reconciliation-loading">A pesquisar pessoas…</div>');
        ...
        function pesquisarWikidataPessoasCirrus(termo, token) {
            ...
            var req = $.ajax({
                ...
                if (!ids.length) {
                    $("#intranet-authority-reconciliation-wikidata").html('<div class="intranet-authority-reconciliation-empty">Sem resultados de pessoas humanas no Wikidata para esta pesquisa.</div>');
        ...
        function pesquisarWikidataEntitySearch(termo, token, filtrarPessoa) {
            var req = $.ajax({
                ...
                if (!ids.length) {
                    $("#intranet-authority-reconciliation-wikidata").html('<div class="intranet-authority-reconciliation-empty">Sem resultados no Wikidata para esta pesquisa.</div>');
                    renderAjudaCriacaoWikidata(false);
                    memorizarEstadoPesquisa();
                    return;
                }
                ...
                if (status === "abort" || token !== STATE.tokenPesquisa) return;
                $("#intranet-authority-reconciliation-wikidata").html('<div class="intranet-authority-reconciliation-error">Erro ao consultar o Wikidata.</div>');
                memorizarEstadoPesquisa();
            });
            registarPedido(req);
        }
        ...
        function carregarResultadosWikidataPorIds(ids, token, exigirPessoa) {
            ...
            var req = $.ajax({
                ...
                if (!resultados.length) {
                    ...
                    $("#intranet-authority-reconciliation-wikidata").html('<div class="intranet-authority-reconciliation-empty">' + escaparHTML(msg) + '</div>');
                    renderAjudaCriacaoWikidata(false);
                    memorizarEstadoPesquisa();
                    return;
                }
                ...
                if (token !== STATE.tokenPesquisa) return;
                $("#intranet-authority-reconciliation-wikidata").html('<div class="intranet-authority-reconciliation-error">Erro ao obter detalhes do Wikidata.</div>');
                memorizarEstadoPesquisa();
            });
            registarPedido(req);
        }
        ...
        function apresentarResultadosWikidata(resultados, labelsMap) {
            ...
            resultados.forEach(function (r) {
                ...
                html += '<div class="intranet-authority-reconciliation-result"><div class="intranet-authority-reconciliation-wd-layout">';
                html += imagem ? '<img class="intranet-authority-reconciliation-photo" src="' + escaparAttr(imagem) + '" alt="' + escaparAttr(label) + '">' : '<div class="intranet-authority-reconciliation-placeholder"></div>';
                html += '<div><div class="intranet-authority-reconciliation-result-name">' + escaparHTML(label) + '</div>';
                if (descricao) html += '<div class="intranet-authority-reconciliation-desc">' + escaparHTML(descricao) + '</div>';
                html += '<div class="intranet-authority-reconciliation-id">' + escaparHTML(qid) + '</div>';
                ...
                html += '<div class="intranet-authority-reconciliation-actions intranet-authority-reconciliation-result-main-actions">' +
                    '<a class="intranet-authority-reconciliation-link" href="https://www.wikidata.org/wiki/' + encodeURIComponent(qid) + '" target="_blank" rel="noopener noreferrer">Abrir</a>' +
                    '<button type="button" class="intranet-authority-reconciliation-btn intranet-authority-reconciliation-primary intranet-authority-reconciliation-apply" data-valor="' + escaparAttr(qid) + '" data-fonte="wikidata">Aplicar Wikidata</button>' +
                    '</div>';
                ...
                if (variantes400.length) {
                    html += '<div class="intranet-authority-reconciliation-result-variants"><div class="intranet-authority-reconciliation-result-variants-title">Candidatos ao 400</div><div class="intranet-authority-reconciliation-variants-list">';
                    variantes400.forEach(function (nomeVariante) {
                        var comp400 = decomporVariantePara400(nomeVariante);
                        html += '<div class="intranet-authority-reconciliation-variant-row"><span class="intranet-authority-reconciliation-variant-name">' + escaparHTML(nomeVariante) + '</span>' +
                            (comp400 ? '<button type="button" class="intranet-authority-reconciliation-btn intranet-authority-reconciliation-add-400" data-forma="' + escaparAttr(nomeVariante) + '">Adicionar ao 400</button>' : '<span class="intranet-authority-reconciliation-muted" title="Forma não decomponível com segurança">Rever</span>') +
                            '</div>';
                    });
                    html += '</div></div>';
                }
            ...
            $("#intranet-authority-reconciliation-wikidata").html(html || '<div class="intranet-authority-reconciliation-empty">Sem resultados.</div>');
            memorizarEstadoPesquisa();
        }
        ...
        function pesquisarVIAF(termo, token) {
            $("#intranet-authority-reconciliation-viaf").html('<div class="intranet-authority-reconciliation-loading">A pesquisar…</div>');
            ...
            requisitarVIAF(termo, function (dados) {
                ...
                if (!lista.length) {
                    $("#intranet-authority-reconciliation-viaf").html('<div class="intranet-authority-reconciliation-empty">Sem resultados VIAF.</div>');
                    memorizarEstadoPesquisa();
                    return;
                }
                ...
                lista.slice(0, CONFIG.maxResultadosVIAF).forEach(function (item) {
                    ...
                    html += '<div class="intranet-authority-reconciliation-result">' +
                        '<div class="intranet-authority-reconciliation-result-name">' + escaparHTML(termoResultado || "VIAF") + '</div>' +
                        '<div class="intranet-authority-reconciliation-id">' + escaparHTML(viafid) + '</div>' +
                        '<div class="intranet-authority-reconciliation-actions">' +
                            '<a class="intranet-authority-reconciliation-link" href="https://viaf.org/viaf/' + encodeURIComponent(viafid) + '" target="_blank" rel="noopener noreferrer">Abrir</a>' +
                            '<button type="button" class="intranet-authority-reconciliation-btn intranet-authority-reconciliation-primary intranet-authority-reconciliation-apply" data-valor="' + escaparAttr(viafid) + '" data-fonte="viaf">Aplicar VIAF</button>' +
                        '</div>' +
                    '</div>';
                });

                $("#intranet-authority-reconciliation-viaf").html(html || '<div class="intranet-authority-reconciliation-empty">Sem resultados VIAF.</div>');
                memorizarEstadoPesquisa();
            }, function () {
                if (token !== STATE.tokenPesquisa) return;
                $("#intranet-authority-reconciliation-viaf").html('<div class="intranet-authority-reconciliation-error">Não foi possível consultar o VIAF.</div><div class="intranet-authority-reconciliation-actions"><button type="button" class="intranet-authority-reconciliation-btn" id="intranet-authority-reconciliation-retry-viaf">Tentar novamente</button></div>');
                memorizarEstadoPesquisa();
            });
        }
        ...
        function tentarCriarNovo017(callback) {
            ...
            try {
                ...
                console.warn("Authority Reconciliation: não foi possível acionar a repetição do campo 017", e);
                callback(null);
                return;
            }
        ...
        function capturarEstadoResultadosPesquisa() {
            return {
                termo: limparTexto($("#intranet-authority-reconciliation-term").val() || ""),
                wikidataHtml: $("#intranet-authority-reconciliation-wikidata").length ? $("#intranet-authority-reconciliation-wikidata").html() : "",
                viafHtml: $("#intranet-authority-reconciliation-viaf").length ? $("#intranet-authority-reconciliation-viaf").html() : "",
                createHtml: $("#intranet-authority-reconciliation-create-area").length ? $("#intranet-authority-reconciliation-create-area").html() : "",
                estadoHtml: $("#intranet-authority-reconciliation-state").length ? $("#intranet-authority-reconciliation-state").html() : ""
            };
        }

        function restaurarEstadoResultadosPesquisa(snapshot) {
            if (!snapshot) return;
            if (snapshot.termo && $("#intranet-authority-reconciliation-term").length) $("#intranet-authority-reconciliation-term").val(snapshot.termo);
            if (snapshot.wikidataHtml && $("#intranet-authority-reconciliation-wikidata").length) $("#intranet-authority-reconciliation-wikidata").html(snapshot.wikidataHtml);
            if (snapshot.viafHtml && $("#intranet-authority-reconciliation-viaf").length) $("#intranet-authority-reconciliation-viaf").html(snapshot.viafHtml);
            if (snapshot.createHtml && $("#intranet-authority-reconciliation-create-area").length) $("#intranet-authority-reconciliation-create-area").html(snapshot.createHtml);
            if (snapshot.estadoHtml && $("#intranet-authority-reconciliation-state").length) $("#intranet-authority-reconciliation-state").html(snapshot.estadoHtml);
        }

        /** Guarda a pesquisa atual para sobreviver a rerenders e ao fechar/reabrir o painel. */
        function memorizarEstadoPesquisa() {
            if (!$("#intranet-authority-reconciliation-term").length) return;
        ...
        function garantirControloGrafo(qid) {
            ...
            var $acc = $('.intranet-authority-reconciliation-accordion[data-accordion="graph"]');
            if ($acc.length) {
                $acc.find('#intranet-authority-reconciliation-graph-area').attr('data-qid', qid);
                return;
            }

            var html = criarAccordion('graph', 'Painel de Identidade', 'Wikidata, Wikimedia Commons e Wikipedia', false,
                '<div id="intranet-authority-reconciliation-graph-area" class="intranet-authority-reconciliation-graph-slot" data-qid="' + escaparAttr(qid) + '"></div>');
            $('#intranet-authority-reconciliation-body').prepend(html);
        ...
        function aplicarNoCampo017(valor, fonte) {
            ...
            function concluirAplicacao(campo) {
                ...
                try {
                    ...
                    if (!confirmado) {
                        setEstado("O valor foi escrito, mas o Authority Reconciliation não conseguiu confirmar o novo 017. Verifique o campo antes de gravar.", true);
                        return;
                    }
                    ...
                    console.error("Authority Reconciliation: erro ao aplicar 017", e);
        ...
        function renderAjudaCriacaoWikidata(expandida) {
            var $area = $("#intranet-authority-reconciliation-create-area");
            if (!$area.length) return;
            ...
            if (!expandida) {
                $area.html('<div class="intranet-authority-reconciliation-create-trigger"><button type="button" class="intranet-authority-reconciliation-btn" id="intranet-authority-reconciliation-prepare-wikidata">Não encontrou? Preparar novo item no Wikidata</button></div>');
                return;
            }
            ...
            var html = '' +
                '<div class="intranet-authority-reconciliation-box intranet-authority-reconciliation-box-spaced">' +
                    '<div class="intranet-authority-reconciliation-box-head"><strong>Preparar novo item Wikidata</strong><span class="intranet-authority-reconciliation-chip">assistido</span></div>' +
                    '<div class="intranet-authority-reconciliation-box-body">' +
                        '<div class="intranet-authority-reconciliation-desc">Dados preparados exclusivamente a partir desta autoridade UNIMARC. Reveja-os antes de executar o QuickStatements.</div>' +
                        (nome ? meta("Nome", nome) : '') +
                        '<div class="intranet-authority-reconciliation-meta"><strong>Tipo:</strong> ser humano (P31 = Q5)</div>' +
                        ...
                        (viaf ? meta("VIAF", viaf) : '<div class="intranet-authority-reconciliation-meta"><strong>VIAF:</strong> não existe no 017; não será acrescentado.</div>') +
                        (a.datas && !datas.interpretada ? '<div class="intranet-authority-reconciliation-meta"><strong>Datas não transportadas:</strong> ' + escaparHTML(a.datas) + ' (formato ambíguo)</div>' : '') +
                        '<div class="intranet-authority-reconciliation-actions">' +
                            '<a class="intranet-authority-reconciliation-link intranet-authority-reconciliation-primary" href="' + escaparAttr(newItemUrl) + '" target="_blank" rel="noopener noreferrer">Criar manualmente no Wikidata</a>' +
                            '<a class="intranet-authority-reconciliation-link" href="' + escaparAttr(qsUrl) + '" target="_blank" rel="noopener noreferrer">Abrir QuickStatements preparado</a>' +
                            '<button type="button" class="intranet-authority-reconciliation-btn" id="intranet-authority-reconciliation-copy-qs" data-qs="' + escaparAttr(qs) + '">Copiar comandos</button>' +
                        '</div>' +
                        '<div class="intranet-authority-reconciliation-desc intranet-authority-reconciliation-desc-spaced">Depois de criar o item, volte ao Authority Reconciliation e pesquise novamente o nome para aplicar o novo QID ao 017.</div>' +
                    '</div>' +
                '</div>';
        ...
        function copiarQuickStatements() {
            var qs = String($("#intranet-authority-reconciliation-copy-qs").attr("data-qs") || "");
            if (!qs) return;
        ...
        function preencherPesquisa(valor) {
            if ($("#intranet-authority-reconciliation-term").length && !limparTexto($("#intranet-authority-reconciliation-term").val())) {
                $("#intranet-authority-reconciliation-term").val(valor || "");
            }
        }


        function setEstado(msg, erro) {
            var $el = $("#intranet-authority-reconciliation-state");
            if (!$el.length) return;
            $el.text(msg || "").css("color", erro ? "#b42318" : "#475467");
        }

        function meta(titulo, valor) {
            return '<div class="intranet-authority-reconciliation-meta"><strong>' + escaparHTML(titulo) + ':</strong> ' + escaparHTML(valor) + '</div>';
        }
